...
class LegalDoc {
  ...
  LegalDoc({required this.docType, required this.version, required this.title, required this.url});
...
class ComplianceRow {
  ...
  ComplianceRow({required this.docType, required this.requiredVersion, required this.acceptedVersion, required this.isOk});
